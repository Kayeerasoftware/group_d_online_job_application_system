<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 md:gap-4">
        <div class="bg-white rounded-lg shadow-md p-4 text-center">
            <p class="text-gray-600 text-sm font-semibold mb-2">Profile Completion</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p class="text-lg text-gray-900 mt-1">{{ auth()->user()->location ?? 'Not provided' }}</p>
                </div>
                <div class="md:col-span-2">
                    <label class="text-sm font-semibold text-gray-600">Bio</label>
                    <p class="text-lg text-gray-900 mt-1">{{ auth()->user()->bio ?? 'No bio added yet' }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="space-y-3">
                ...
                <a href="#" class="block w-full px-4 py-3 bg-green-50 text-green-600 rounded-lg font-semibold hover:bg-green-100 transition text-center">
                    <i class="fas fa-lock mr-2"></i>Change Password
                </a>
                <a href="#" class="block w-full px-4 py-3 bg-purple-50 text-purple-600 rounded-lg font-semibold hover:bg-purple-100 transition text-center">
                    <i class="fas fa-bell mr-2"></i>Notifications
                </a>
                <a href="#" class="block w-full px-4 py-3 bg-orange-50 text-orange-600 rounded-lg font-semibold hover:bg-orange-100 transition text-center">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="flex flex-wrap gap-2">
                <span class="px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold">Laravel</span>
                <span class="px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold">PHP</span>
                <span class="px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold">JavaScript</span>
                <span class="px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold">React</span>
                <span class="px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold">MySQL</span>
                <span class="px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-semibold">Git</span>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="space-y-4">
                <div class="border-l-4 border-purple-600 pl-4">
                    <p class="font-semibold text-gray-900">Senior Developer</p>
                    <p class="text-sm text-gray-600">Tech Company • 2 years</p>
                </div>
                <div class="border-l-4 border-purple-600 pl-4">
                    <p class="font-semibold text-gray-900">Junior Developer</p>
                    <p class="text-sm text-gray-600">Startup • 1 year</p>
                </div>
            </div>
            <a href="{{ route('seeker.profile.edit') }}" class="mt-4 inline-block text-blue-600 font-semibold hover:underline">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6">
        ...
        <div class="space-y-4">
            <div class="border-l-4 border-indigo-600 pl-4">
                <p class="font-semibold text-gray-900">Bachelor of Science in Computer Science</p>
                <p class="text-sm text-gray-600">University of Technology • 2020</p>
            </div>
        </div>
        <a href="{{ route('seeker.profile.edit') }}" class="mt-4 inline-block text-blue-600 font-semibold hover:underline">
